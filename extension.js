...
function makeRange(startRange, endRange) {
	return document.validateRange(new vscode.Range(startRange, endRange));
}
...
function activate(context) {
	...
	let disposableSelectionOrFile = vscode.commands.registerCommand(
	...
	let disposableEntireFile = vscode.commands.registerCommand(
...
function deactivate() {
	console.log('"Remove non ASCII chars" is sad to see you go...');
}
